...
function scr_hat_sprites(entry)
{
	switch entry
	{
		...
		case HAT.snick: return spr_snickhat;
...
function scr_pet_sprites(entry)
{
	...
	switch entry
	{
		...
		case PET.boykiss:
			s.spr_idle = spr_petboykiss_idle;
			s.spr_run = spr_petboykiss_run;
			s.spr_taunt = spr_petboykiss_taunt;
			break;
		...
		case PET.gooch:
			...
			case PET.mario:
			s.spr_idle = spr_petmario_idle;
			s.spr_run = spr_petmario_move;
			break;
			
			case PET.grunt:
			s.spr_idle = spr_petgrunt_idle;
			s.spr_run = spr_petgrunt_move;
			break;
	}
	return s;
}
