...
else switch character
{
	default: case "P": case "G":
		...
		add_palette(36).set_prefix(); // Meat
...
if global.sandbox or character == "V"
{
	...
	add_pattern(spr_pattern_lamb, "pattern_V2").set_entry("lamb"); // Vindox
	add_pattern(spr_pattern_battery, "pattern_V3").set_entry("battery"); // Vindox
	add_pattern(spr_pattern_brain, "pattern_V4").set_entry("brain"); // Vindox
	add_pattern(spr_pattern_ghost, "pattern_V5").set_entry("ghost"); // Vindox
	add_pattern(spr_pattern_spot, "pattern_V6").set_entry("spot"); // Vindox
	add_pattern(spr_pattern_dogma, "pattern_V7").set_entry("dogma"); // SmashKid15
	add_pattern(spr_pattern_unholy, "pattern_V8").set_entry("unholy"); // SmashKid15
	add_pattern(spr_pattern_gehenna, "pattern_V9").set_entry("gehenna"); // Vindox
...
add_pattern(spr_pattern_redcrown).set_entry("redcrown"); // SmashKid15
add_pattern(spr_pattern_steven).set_entry("steven"); // SmashKid15
add_pattern(spr_pattern_drug).set_entry("drug"); //Piss Towel
add_pattern(spr_pattern_smash).set_entry("smash"); //United CE
add_pattern(spr_pattern_astral).set_entry("astral"); //Pixel Jinx

add_pattern(spr_pattern_missing); // PTT
add_pattern(spr_pattern_spooky); // PTT
add_pattern(spr_pattern_code); // PTT
add_pattern(spr_pattern_wire); // PTT
add_pattern(spr_pattern_genesis); // PTT
add_pattern(spr_pattern_mobius); // PTT
add_pattern(spr_pattern_fungus); // PTT
add_pattern(spr_pattern_snick); // PTT
add_pattern(spr_pattern_giygas); // PTT
add_pattern(spr_pattern_spherical); // PTT
add_pattern(spr_pattern_invader); // PTT
add_pattern(spr_pattern_fatal); // PTT
add_pattern(spr_pattern_supreme); // Lila
add_pattern(spr_pattern_lava); // PTT
add_pattern(spr_pattern_water); // PTT
add_pattern(spr_pattern_nether); // PTT
add_pattern(spr_pattern_boykisser); // Lila
...
add_pattern(spr_pattern_blocks); // ??
