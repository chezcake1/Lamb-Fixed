...
with new ModSection("visual", 2)
{
	...
	var opt = add_option("richpresence", function(val)
	{
		...
		if val
		{
			...
			var name = "Pizza Tower Lamb Fixes";
	...
	var opt = add_option("toppin", function(val)
	{
		if val == 0
		{
			draw_sprite(spr_toppinshroom, super.image_index, 960 / 5 - 32 - 80, 540 / 5 - 32);
			draw_sprite(spr_toppintomato, super.image_index, 960 / 5 - 16, 540 / 5 - 16);
			draw_sprite(spr_toppinpineapple, super.image_index, 960 / 5 - 32 + 80, 540 / 5 - 32);
		}
		if val == 1
		{
			draw_sprite(spr_toppinshroom_gal, super.image_index, 960 / 5 - 32 - 80, 540 / 5 - 32);
			draw_sprite(spr_toppintomato_gal, super.image_index, 960 / 5 - 16, 540 / 5 - 16);
			draw_sprite(spr_toppinpineapple_gal, super.image_index, 960 / 5 - 32 + 80, 540 / 5 - 32);
		}
	}, true);
	opt.opts = [
		["base", TOPPIN_STYLES.base],
		["minus8", TOPPIN_STYLES.minus8],
	]
	...
	var opt = add_option("enemyrot", [seq_enemyrot_off, seq_enemyrot_on]);
...
with lap_submenu
{
	...
	/*var opt = add_option("johnlap", [seq_johnlap_off, seq_johnlap_on]);
	opt.condition = function()
	{
		return [global.lapmode == LAP_MODES.laphell, lstr("mod_condition_lap3checkpoint")];
	}*/
