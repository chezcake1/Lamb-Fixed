...
{
spr_intro = spr_toppinshroom_intro_gal;
spr_idle = spr_toppinshroom_gal;
spr_run = spr_toppinshroom_run_gal;
spr_panic = spr_toppinshroom_panic_gal;
spr_taunt = spr_toppinshroom_taunt_gal;
}