...
/*if TOPPIN_STYLES.minus8
{
spr_intro = spr_toppinpineapple_intro_gal;
spr_idle = spr_toppinpineapple_gal;
spr_run = spr_toppinpineapple_run_gal;
spr_panic = spr_toppinpineapple_panic_gal;
spr_taunt = spr_toppinpineapple_taunt_gal;
}