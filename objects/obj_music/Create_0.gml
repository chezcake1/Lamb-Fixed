...
add_music(war_1, "event:/music/w5/war", "event:/music/w5/warsecret", false, function(event)
{
    if (global.laps == 3)
        fmod_event_instance_set_parameter(event,"state", 3, true);
    else
        fmod_event_instance_set_parameter(event, "state", 0, true);
})
add_music(war_lap, "event:/music/w5/war", "event:/music/w5/warsecret", false, function(event)
{
    if (global.laps == 2)
        fmod_event_instance_set_parameter(event,"state", 3, true);
    else
