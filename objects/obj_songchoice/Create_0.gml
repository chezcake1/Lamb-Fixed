...
with new JukeboxSection("Pizza Tower", 0)
{
	...
	add_song("event:/soundtest/base/pizzaheadnoise", "Unexpectancy, Part 3 (Noise-Mix) - ClascyJitto");
...
with new JukeboxSection("Lamb Fixes", 2)
{
	...
	add_song("event:/soundtest/pto/forafewtoppings", "For A Few Toppings - MrSaucemann");
	...
	add_separator();
	add_song("event:/soundtest/pto/entrancevigil", "Show On The Road - ValentinaTheWatermelon");
	add_song("event:/soundtest/pto/pizzatimevigil", "Bullet Dancing - ValentinaTheWatermelon");
	add_song("event:/soundtest/pto/lap2vigil", "Lick And A Promise - ValentinaTheWatermelon");
	add_song("event:/soundtest/pto/pizzaheadvigil", "Unexpectancy, Part 3 (Justice-Mix) - ValentinaTheWatermelon");
	add_song("event:/soundtest/pto/vigilfinalescape", "Same Song, Different Dance - ValentinaTheWatermelon");
	add_song("event:/soundtest/pto/vigilcredits", "Deadeye's Hoedown - ValentinaTheWatermelon");
	
	add_separator();
	add_song("event:/soundtest/pto/lap3", "Pillar John's Revenge - Vozaxhi");
	add_song("event:/soundtest/pto/lap4", "Absolute AbsurZiti - Inceptradom");
	add_song("event:/soundtest/pto/lap3N", "Special Guest Showdown - SeagullBruh");
	add_song("event:/soundtest/pto/lap4N", "Jam-Packed Joyride - BellIffy and BilkShaked");
	add_song("event:/soundtest/pto/lap3V", "Final Duel at High Noon - TheoKnug");
	add_song("event:/soundtest/pto/lap4V", "Memento Morinara - Dim Widdy");
	add_song("event:/soundtest/pto/infinity", "Death Wish - Pascal Michael Stiefel");
	add_song("event:/soundtest/pto/thousandremix", "Thousand March (Remix) - RichaadEB");
...
with new JukeboxSection("Bonus!", 3)
{
	...
	add_song("event:/soundtest/extras/eatinrats", "Eatin' Rats - Ridiculon");
	add_song("event:/soundtest/extras/futuremeetspast", "Future Meets The Past - Ridiculon");
}
