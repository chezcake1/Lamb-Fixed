...
credits = [
	...
	[noone, string_replace_all(lang_get_value_newline_raw("en", "credits_lamb1"), "%", "\"")],
	[noone, string_replace_all(lang_get_value_newline_raw("en", "credits_lamb2"), "%", "\"")],
	[noone, string_replace_all(lang_get_value_newline_raw("en", "credits_lamb3"), "%", "\"")],
	[noone, string_replace_all(lang_get_value_newline_raw("en", "credits_lamb4"), "%", "\"")],
	[noone, string_replace_all(lang_get_value_newline_raw("en", "credits_lamb5"), "%", "\"")],
	[noone, string_replace_all(lang_get_value_newline_raw("en", "credits_lamb6"), "%", "\"")],
	[noone, string_replace_all(lang_get_value_newline_raw("en", "credits_lamb7"), "%", "\"")],
	[noone, string_replace_all(lang_get_value_newline_raw("en", "credits_lamb8"), "%", "\"")],
