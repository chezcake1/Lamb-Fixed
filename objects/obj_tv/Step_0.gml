	...
	case states.normal:
		...
		if global.hud == HUD_STYLES.final
		{
			if PANIC
				...
				if (global.laps == 2) && (LAP_MODES.laphell)
				idlespr = obj_player1.isgustavo ? spr_tv_lap3G : spr_tv_exprheat;
				if (global.laps == 3) && (LAP_MODES.laphell)
				idlespr = obj_player1.isgustavo ? spr_tv_gusweeping : spr_tv_lap4panic;
